...
export const ALCHEMY_API_KEY = 'B4kGVnNFsfTb8_3AodMUerrIAuKDSbaV';//'44wMYVLkygXznIGHzFN8fF8JoPVx1ykc';
...
export const RPC_URL = 'https://arb-sepolia.g.alchemy.com/v2/B4kGVnNFsfTb8_3AodMUerrIAuKDSbaV'; //`https://arb-mainnet.g.alchemy.com/v2/${ALCHEMY_API_KEY}`;
